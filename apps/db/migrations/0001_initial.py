# Generated by Django 5.2 on 2025-10-20 14:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('controller_uuid',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auditlog_controller',
                                   to='db.systeminfo', to_field='uuid', verbose_name='控制端UUID')),
            ],
            options={
                'verbose_name': '审计日志',
            ...
            fields=[
                ...
                ('client',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.systeminfo', to_field='uuid',
                                   verbose_name='设备UUID')),
                ('tag_id',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.tag', verbose_name='标签')),
            ],
            options={
