    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conn_id', models.IntegerField(null=True, verbose_name='连接ID')),
                ...
                ('operation_type',
                 models.IntegerField(choices=[(1, 'upload'), (0, 'download')], default=1, verbose_name='操作类型')),
                ('is_file', models.BooleanField(verbose_name='是否文件')),
                ('remote_path', models.CharField(null=True, verbose_name='远程路径')),
                ('file_info', models.TextField(null=True, verbose_name='文件信息')),
                ('user_id', models.CharField(max_length=50, null=True, verbose_name='操作用户')),
                ('file_num', models.IntegerField(null=True, verbose_name='文件数量')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('controller_uuid', models.CharField(max_length=255, null=True, verbose_name='控制端UUID')),
                ('controlled_uuid', models.CharField(max_length=255, verbose_name='被控端UUID')),
                ('type',
                 models.IntegerField(choices=[(0, 'connect'), (1, 'file_transfer'), (2, 'tcp_tunnel'), (3, 'camera')],
                                     default=0, verbose_name='类型')),
                ('user_id', models.CharField(max_length=50, null=True, verbose_name='发起连接的用户')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
            ],
            options={
                'verbose_name': '审计日志',
