    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE,
                                               ...
                                               verbose_name='用户名')),
                ('uuid',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.peerinfo', to_field='uuid',
                                   verbose_name='设备UUID')),
            ],
            options={
                'verbose_name': '日志',
            ...
            fields=[
                ...
                ('controlled_uuid',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auditlog_controlled',
                                   to='database.peerinfo', to_field='uuid', verbose_name='被控端UUID')),
                ('controller_uuid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                                      related_name='auditlog_controller', to='database.peerinfo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operation_info', models.CharField(default='', max_length=255, null=True, verbose_name='操作信息')),
                ('is_file', models.BooleanField(verbose_name='是否文件')),
                ('remote_path', models.CharField(default='', max_length=255, null=True, verbose_name='远程路径')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('controlled_uuid', models.ForeignKey(max_length=255, on_delete=django.db.models.deletion.CASCADE,
                                                      related_name='auditfile_controlled', to='database.peerinfo',
                ...
                ('controller_uuid', models.ForeignKey(max_length=255, on_delete=django.db.models.deletion.CASCADE,
                                                      related_name='auditfile_controller', to='database.peerinfo',
                                                      to_field='uuid', verbose_name='控制端UUID')),
            ],
            options={
                'verbose_name': '审计文件',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personal_type',
                 models.CharField(choices=[('public', '公开'), ('private', '私有')], default='public', max_length=255,
                                  verbose_name='地址簿类型')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('create_user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.CharField(max_length=255, null=True, verbose_name='设备UUID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guid', models.CharField(max_length=50, verbose_name='GUID')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_peer_tags',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('peer_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='alias_peer_id',
                                              to='database.peerinfo', to_field='peer_id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guid', models.CharField(max_length=50, verbose_name='GUID')),
                ('create_user',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tag_create_user',
                                   to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '标签',
