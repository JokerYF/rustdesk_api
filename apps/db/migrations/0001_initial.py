# Generated by Django 5.2.8 on 2025-11-19 02:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.peerinfo',
                                           verbose_name='设备ID')),
            ],
            options={
                'verbose_name': '日志',
            ...
            fields=[
                ...
                ('controlled_uuid',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auditlog_controlled',
                                   to='db.peerinfo', verbose_name='被控端ID')),
